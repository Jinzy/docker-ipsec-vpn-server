FROM debian:stretch
LABEL maintainer="Jin Zhengyu <zhengyu.jin@gmail.com>"

ENV REFRESHED_AT 2019-05-9
ENV SWAN_VER 3.27
ENV L2TP_VER 1.3.12
#ENV VPN_L2TP_NET '172.26.0.0/16'
#ENV VPN_L2TP_LOCAL '172.26.191.1'
#ENV VPN_L2TP_POOL '172.26.191.10-172.26.191.250'
#ENV VPN_XAUTH_NET '172.26.192.0/16'
#ENV VPN_XAUTH_POOL '172.26.192.10-172.26.192.250'
ENV VPN_L2TP_NET '172.16.0.0/12'
ENV VPN_L2TP_LOCAL '172.16.30.1'
ENV VPN_L2TP_POOL '172.16.30.10-172.16.30.250'
ENV VPN_XAUTH_NET '172.16.31.0/12'
ENV VPN_XAUTH_POOL '172.16.31.10-172.16.31.250'
